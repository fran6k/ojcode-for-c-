...
public:
    ...
    void pd() {
        ...
        else if ((year  >= 2015 && month >= 4 && day >= 7) || (year >= 2015 && month > 4)) {
            cout << "this software is going to be expired in " << getDayofYear() - 97 << " days" << endl;
        }
        else 
...
public:
    software(string n, string t, string m) {
        name = n;
        if (t == "O")
            type = "original";
        if (t == "B")
