...
void tran(double* value, string p) {
	if (p == "D")
		cout << fixed << setprecision(4) << *value * 6.2619 << endl;
	if (p == "E")
		cout << fixed << setprecision(4) << *value * 6.6744 << endl;
	if (p == "Y")
		cout << fixed << setprecision(4) << *value * 0.0516 << endl;
	if (p == "H")
		cout << fixed << setprecision(4) << *value * 0.8065 << endl;
}
