...
public:
    string name;
    int xuehao;
	string zhuanye,fangxiang,xinbie,sushe,sj;
};
...
int main() {
 ...
 for(i = 0;i<T;i++){
  cin >>students[i].name;
  cin >>students[i].xuehao;
  cin >>students[i].zhuanye;
  cin >>students[i].fangxiang;
  cin >>students[i].xinbie;
  cin >>students[i].sushe;
  cin >>students[i].sj;
 }
 for(i=0;i<T;i++){
  cout << students[i].name<< " " << students[i].xuehao<< " " <<students[i].zhuanye<< " " <<students[i].fangxiang<< " " <<students[i].xinbie<< " " <<students[i].sushe<< " " <<students[i].sj<<endl;
 } 
    return 0;
}